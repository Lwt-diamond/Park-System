...
public class CancelJPanel extends JPanel{
    ...
    public JCheckBox endTimeCheckBox;
    ...
    public static void main(String[] args) {
        ...
        contentJpanel.add(new CancelJPanel());
    ...
    public CancelJPanel() {
        ...
        dataJTabel.addMouseListener(new CancelJPanelListener(this));
        ...
        refreshButton.addActionListener(new CancelJPanelListener(this));
